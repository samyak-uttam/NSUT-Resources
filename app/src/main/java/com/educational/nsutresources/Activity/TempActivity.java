...
public class TempActivity extends AppCompatActivity implements DataAdapter.ListItemClickListener {
    ...
    private class ATask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                Toast.makeText(TempActivity.this, "Sorry, an error occured!", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
            return null;
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (!data.isEmpty() && data.size() > 0) {
                mAdapter = new DataAdapter(data, TempActivity.this);
    ...
    private class DownloadFile extends AsyncTask<Integer, Integer, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            super.onPostExecute(aVoid);
            Intent intent = new Intent(TempActivity.this, PdfActivity.class);
            intent.putExtra("name", data.get(index));
            startActivity(intent);
