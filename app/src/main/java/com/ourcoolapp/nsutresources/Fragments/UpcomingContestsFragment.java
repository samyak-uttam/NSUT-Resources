...
import com.ourcoolapp.nsutresources.Adapter.DsAlgoAdapter;
import com.ourcoolapp.nsutresources.Class.Contest;
import com.ourcoolapp.nsutresources.Loader.DsAlgoLoader;
import com.ourcoolapp.nsutresources.R;

import java.util.ArrayList;

public class UpcomingContestsFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<Contest>> {
    ...
    public Loader<ArrayList<Contest>> onCreateLoader(int id, @Nullable Bundle args) {
        return new DsAlgoLoader(getActivity(), 2);
    }
